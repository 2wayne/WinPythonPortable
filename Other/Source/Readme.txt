...
user in an INI file next to WinPythonCommandPortable.exe called WinPythonCommandPortable.ini.
...
copy AppNamePortable.ini from this directory to WinPythonCommandPortable.ini next to
WinPythonCommandPortable.exe. The options in the INI file are as follows:
